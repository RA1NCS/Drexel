// ALL CREDITS TO PROFESSOR BRIAN L. STUART FOR THIS, THIS IS JUST A MODIFIED VERSION FOR STYLING THE BUTTON
// ORIGINAL: https://www.cs.drexel.edu/~bls96/tvm.js
...
function startvm() {
	...
	tabnum = 0
	document.write('<html>\n<body>\n')
	document.write('<button onclick="start();">Start Program</button><br>\n')
	document.write('<br>')
	document.write("<style> button {font-family: 'Questrial'; border-radius: 8px; color: white; background-color: rgba(207,207,207,0.3); border-color: white; box-shadow: 0px 0px 5px lightblue; padding: 6px;}")
	document.write("textarea {font-family: 'Questrial'; background-color: transparent; color: white; text-align: center; text-shadow: 0px 0px 5px white; border-radius: 5px; padding: 19px 0; overflow: hidden;}")
	document.write('</style>')
	document.write('<textarea id="stdout" cols="60" rows="4"></textarea>')
	document.write('</body>\n</html>\n')
	m = JSON.parse(tape)
	sp = 65535
	fp = 65535
