...
function startvm() {
	...
	document.write("<br>")
    document.write("<style> button {font-family: 'Questrial'; border-radius: 5px; color: white; background-color: rgba(207,207,207,0.3); border-color: white; box-shadow: 0px 0px 5px lightblue; padding: 6px;}")
